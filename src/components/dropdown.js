...
const StyledUl = styled.ul`
  ...
  transition: opacity 200ms cubic-bezier(0.445, 0.05, 0.55, 0.95) 0s, transform 200ms cubic-bezier(0.445, 0.05, 0.55, 0.95) 0s, visibility 200ms cubic-bezier(0.445, 0.05, 0.55, 0.95) 0s;
...
`
const CurrencyListItem = ({ code,logoImageUrl, isCurrentCurrency, setCurrentCurrency, setDropdownIsActive, setCurrencyAmount }) => (
  <li key={code}><button onClick={e => {
    e.preventDefault()
    ...
    }}><CurrencyWithLogo logoImageUrl={logoImageUrl} currentCurrency={code} /></button>
  </li>
)

const Dropdown = ({ setCurrencyAmount, setDropdownIsActive, dropdownIsActive, assets, currentCurrency, setCurrentCurrency }) => {
